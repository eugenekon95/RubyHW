...
puts "86 Дан целочисленный массив. Найти cреднее арифметическое его элементов."
p arr = Array.new(10) { rand(-100...100) }
...
p "6 Дан целочисленный массив. Преобразовать его, прибавив к четным числам последний элемент.
     Первый и последний элементы массива не изменять."
def addLastToEvens
  p arr = Array.new(10) { rand(-100...100) }
  arr.each do |el|
...
p "7 Дан целочисленный массив. Преобразовать его, прибавив к нечетным числам последний элемент.
     Первый и последний элементы массива не изменять."
...
p "8 Дан целочисленный массив. Преобразовать его, прибавив к нечетным числам первый элемент.
     Первый и последний элементы массива не изменять."
def addFirstToOdds
    p arr = Array.new(10) { rand(-100...100) }
    arr.each do |el|
...
p "79 Дан целочисленный массив. Возвести в квадрат отрицательные элементы 
